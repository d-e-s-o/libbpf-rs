...
///
/// Tests generally work with [`Object`][libbpf_rs::Object] directly, to
/// stay independent of `libbpf-cargo`. Only functionality that is not
/// reachable that way warrants a skeleton.
